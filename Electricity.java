...
public class Electricity
{
	...
	// Function to calculate the truncated percentage of user's consumption compared to average Indian consumtion. 
	...
	// Function to check weather the passed string is numeric
	...
	{  
		...
		// Program accepts Command Line Arguements
		if (args.length != 0)
		{
			textfield1.setText(args[0]);
			button1.doClick();
		}  
